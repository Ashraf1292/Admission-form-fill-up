<?php
 ...
 $query = "SELECT Student.Student_ID, Student.Student_Name, Form.Form_ID 
          ...
          WHERE Approval.AR_Approval IS NULL AND Approval.R_Approval IS NOT NULL";
...
<head>
    ...
    <title>Welcome Assistant Registrar</title>
    <link rel="stylesheet" href="login2.css">
</head>

<body class="bg-dark">
    <h1>Welcome Assistant Registrar<br> Student Data</h1>
...
if (isset($_POST['approval'])) {
   ...
   $update_query = "UPDATE Approval SET AR_Approval = '$officials_id' WHERE Form_ID = {$form_id}";
...
if (isset($_POST['disapproval'])) {
    ...
    $form_id_row = mysqli_fetch_assoc($form_id_result);
    $form_id = $form_id_row['Form_ID'];
   $update_query = "UPDATE Approval SET AR_Approval = '$disapproval' WHERE Form_ID = {$form_id}";
