...
if (isset($_POST['approval'])) {
   ...
   $update_query = "UPDATE Approval SET R_Approval = '$officials_id' WHERE Form_ID = {$form_id}";
...
if (isset($_POST['disapproval'])) {
    ...
    $form_id_row = mysqli_fetch_assoc($form_id_result);
    $form_id = $form_id_row['Form_ID'];
   $update_query = "UPDATE Approval SET R_Approval = '$disapproval' WHERE Form_ID = {$form_id}";
